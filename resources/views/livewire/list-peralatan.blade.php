        ...
        <div class="p-6 text-gray-900 dark:text-gray-100">
            <div class="flex justify-center mb-6">
                <div class="inline-flex items-center px-4 py-2 bg-blue-600 dark:bg-blue-700 text-white font-medium rounded-lg shadow-sm">
                    ...
                    <h2 class="text-xl font-bold">DATA PERALATAN</h2>
            ...
            <div class="mb-6 flex flex-wrap gap-3 items-center max-w-4xl mx-auto">
                <div class="flex-1 min-w-64 relative">
                    <input type="text" wire:model.live="search" placeholder="Cari peralatan..."
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-200 dark:bg-gray-700 dark:text-gray-300">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3">Tahun Pengadaan</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse($peralatans as $index => $alat)
                            <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-300">
                                <td class="px-4 py-3 text-center text-gray-500 dark:text-gray-400">{{ $peralatans->firstItem() + $index }}</td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100">{{ $alat->nama }}</td>
                                <td class="px-4 py-3 text-sm text-gray-900 dark:text-gray-100">{{ $alat->jenis_peralatan }}</td>
                                <td class="px-4 py-3 text-sm text-gray-900 dark:text-gray-100">{{ $alat->tahun_pengadaan }}</td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="4" class="px-4 py-12 text-center text-gray-500 dark:text-gray-400">Belum ada data peralatan</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
