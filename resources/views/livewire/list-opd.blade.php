            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <div class="flex justify-center mb-8">
                    <div class="inline-flex items-center px-6 py-3 bg-blue-700 text-white font-black rounded-xl shadow-xl transform hover:scale-105 transition-all duration-300 border border-blue-800/20"
                        ...
                        <i class="fas fa-building mr-3 text-xl text-white"></i>
                        <h2 class="text-2xl uppercase tracking-wider text-white">DATA OPD</h2>
                ...
                <div class="mb-6 flex flex-col md:flex-row justify-between items-center gap-4 bg-gray-50 dark:bg-gray-900/50 p-6 rounded-xl border border-gray-100 dark:border-gray-700">
                    ...
                    <div class="relative w-full md:w-80">
                        ...
                        <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari nama Organisasi Perangkat Daerah..."
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800">
                            ...
                            @forelse($opds as $index => $opd)
                                <tr wire:loading.remove wire:key="opd-{{ $opd->id }}" class="hover:bg-blue-50/50 dark:hover:bg-blue-900/10 transition-colors duration-150 group">
                                ...
                                <tr wire:loading.remove>
                                    <td colspan="2" class="px-6 py-20 text-center">
                                        <div class="flex flex-col items-center justify-center text-gray-400">
                                            <i class="fas fa-building text-6xl mb-4 opacity-10"></i>
                                            <p class="text-xl font-bold tracking-tighter uppercase text-gray-900 dark:text-gray-100">Data OPD Nihil</p>
                                            <p class="text-sm italic font-medium">Coba sesuaikan kata kunci pencarian Anda.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
                ...
                <div class="mt-8 flex flex-col md:flex-row justify-between items-center gap-6 bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
                    <div class="text-sm text-gray-600 dark:text-gray-400 font-medium">
                        Menampilkan <span class="text-gray-900 dark:text-white font-bold">{{ $opds->firstItem() ?? 0 }}</span> - <span class="text-gray-900 dark:text-white font-bold">{{ $opds->lastItem() ?? 0 }}</span> dari total <span class="text-gray-900 dark:text-white font-bold">{{ $totalData }}</span> entri data
                    </div>
