<!-- Header Section -->
    ...
    <nav class="bg-white dark:bg-gray-900 shadow-lg sticky top-0 z-50">
                ...
                <div class="hidden md:flex items-center space-x-1">
                    ...
                    <div class="dropdown relative">
                        <a href="{{ url('/lapor') }}"
                            ...
                            Lapor
                            <span
                                class="ml-2 bg-blue-600 text-white text-xs font-bold px-2 py-0.5 rounded-full">Baru</span>
                        </a>
                    </div>
                </div>
                        ...
                        <div class="dropdown relative">
                            <button class="flex items-center space-x-2 focus:outline-none group">
                                ...
                                <div class="hidden lg:flex flex-col items-start">
                                    ...
                                    <span
                                        class="text-xs text-gray-500">{{ Auth::user()->roles[0]->name ?? 'User' }}</span>
                                </div>
                                <i
        ...
        <!-- Mobile Menu -->
        <div id="mobile-menu" class="mobile-menu md:hidden bg-white border-t border-gray-200 dark:bg-gray-900 dark:border-gray-700">
            <div class="px-2 pt-2 pb-4 space-y-1">
                ...
                <div class="group">
                    <button
                        ...
                        <i
                            class="fas fa-chevron-down text-xs transition-transform duration-200 group-focus:rotate-180"></i>
                    </button>
